...
class Profile extends Component { 
  ...
  render() {
    ...
    <ScrollView data-layer="4347de83-0b0c-47bf-bf53-16703185008e" style={styles.profile}>
        ...
        <Text style={styles.profile_logOut}>Log Out</Text>
          </TouchableOpacity>
         
        <Text data-layer="fec0446d-5c76-4021-a19b-b82ad4fbd22c" style={styles.profile_info}> User Info</Text>
        ...
        <View data-layer="71ebb86c-36d6-4791-a358-4a8f42cb12ad" style={styles.profile_x26}>
            ...
            <ReactImage data-layer="e8e258bb-340f-46bd-a924-cb870c5f3923" source={require('../assets/x1.png')} style={styles.profile_x26_x1} />
            <TouchableOpacity onPress={this.props.home}>
                <ReactImage data-layer="d8928027-7243-4ef7-97ee-72449635dd9b" source={require('../assets/x2.png')} style={styles.profile_x26_x2} />
            </TouchableOpacity>
            <TouchableOpacity onPress={this.props.barCode}>
                 <ReactImage data-layer="4179d4f6-f74e-4cec-861b-d6de97fab452" source={require('../assets/x3.png')} style={styles.profile_x26_x3} />
            </TouchableOpacity>
        </View>
        <Text data-layer="3766fd5f-935e-4e0b-bd05-96a863104314" style={styles.profile_username}>Username : </Text>
        <TouchableOpacity onPress={this.props.setProfileEdit}>
        <Text data-layer="5fc2654a-525d-4520-8428-baae32d77ea2" style={styles.profile_edit}>Edit</Text>
        </TouchableOpacity>
    ...
    <Text data-layer="b775f55e-73d2-4770-95ee-9fabdf16d24b" style={styles.profile_vivi1010}> {this.state.profiles.response.Username}</Text>
        <ReactImage data-layer="0dda5906-a286-49ab-8b1a-24881d5dfb3d" source={require('../assets/x7.png')} style={styles.profile_x7} />
        ...
        <Text data-layer="f7cf7f6c-9ae7-4124-80c4-53eb635a2a67" style={styles.profile_vivi}>{this.state.profiles.response.Email}</Text>
